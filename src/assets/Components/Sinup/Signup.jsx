      ...
      <div className="flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="bg-[#FF6915] w-full lg:w-1/2 flex flex-col items-center justify-center px-6 py-12">
          ...
          <div className="text-center mt-8">
            <h3 className="text-2xl font-[600] mb-2 text-white">Welcome Aboard</h3>
        ...
        <div className="bg-white w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
          <div className="w-full max-w-2xl">
            <p className="text-black text-3xl sm:text-4xl font-[400] mb-8">Create Account</p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="relative mb-4">
                ...
                <img src={emailImg} className="w-4 h-4 absolute right-3 top-3" alt="" />
              </div>
              ...
              <div className="flex gap-6 mb-4">
                ...
                <div className="relative w-full">
                  ...
                  <img src={eye} className="w-4 h-4 absolute right-3 top-3 cursor-pointer" alt=""
