...
const Signin = () => {
  ...
  //login api integerate 
  const handleSubmit = async (e) =>{
    e.preventDefault();
    if(!formData.username || !formData.password){
      setError("please filll all inputs")
      return;
    }
    try {
      setLoading(true);
      ...
      toast.error(error?.message || "something wents wrong. please try again  ")
    }finally {
      setLoading(false)
    }
  };
        ...
        <div className="bg-white w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
          <div className="w-full max-w-2xl">
            ...
            <form onSubmit={handleSubmit}>
              ...
              {error && (
                <p className="text-[#FF6915] font-[600] text-sm mb-3">
                  {error}
                </p>
              )}
              ...
              <button
                type="submit"
                disabled={loading}
                className="bg-[#FF6915] text-white w-full h-10  font-[500] rounded-md disabled:opacity-60"
              >
              ...
              <button
                ...
                className="bg-[#FF6915] text-white font-[500] w-full h-10 rounded-md mt-4"
              >
                Create Account
              </button>
              ...
              <p
                ...
                className="text-center text-sm text-black font-[900] mt-4 cursor-pointer hover:underline"
              >
                Forgot Password?
              </p>
            </form>
